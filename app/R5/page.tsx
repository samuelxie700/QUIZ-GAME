    ...
    <main className="min-h-screen flex items-center justify-center bg-neutral-200">
      ...
      >
        ...
        <div className="absolute left-[38px] top-[329px] w-[299px] h-[42px] bg-[#4D688C] rounded-t-[14px]">
          <div
            className={`${bagel400.className} absolute left-[46px] top-[5px] text-white text-[24px] leading-[32px]`}
          >
            Creative Innovator
          </div>
        </div>
        ...
        >
          <div
            className={`${bagel400.className} absolute left-[29px] top-[5px] text-white text-[16px] leading-[32px]`}
          >
            Base Camp
          </div>
          <div
        ...
        >
          <div
            className={`${bagel400.className} absolute left-[26px] top-[5px] text-white text-[16px] leading-[32px]`}
          >
            Personality
          </div>
          <div
            className={`${dongle700.className} absolute left-[30px] top-[34px] text-white text-[16px] leading-[14px] font-bold text-center`}
          >
            Relaxed Person
          </div>
        </button>
        ...
        >
          ...
          >
            <span className="text-[16px] leading-[32px]" style={{ color: '#4D688C' }}>
              Lucky&nbsp;
            </span>
            <span className="text-[16px] leading-[32px]" style={{ color: '#F2A25C' }}>
              Charm
            </span>
          </div>
          <div
        ...
        >
          ...
          <img
            src="/R5/head.png"
            alt="head"
            className="absolute left-[33px] top-[29px] w-[72px] h-[72px]"
          />
          {/* City Visionary 文本 */}
          <div
            className={`${dongle700.className} absolute text-center`}
            style={{ left: 7, top: 769 - 675, width: 129, height: 14, color: '#4D688C' }}
          >
        ...
        >
          <div
            className={`${bagel400.className} absolute left-[26px] top-[5px] text-[#4D688C] text-[16px] leading-[32px]`}
          >
            Locations
          </div>
        </button>
