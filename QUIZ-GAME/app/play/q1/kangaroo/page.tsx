...
export default function KangarooCharacterPage() {
  ...
  const onConfirm = () => {
    const url = `/play?avatar=${encodeURIComponent(avatar)}&partner=kangaroo`;
    router.push(url);
  };
  ...
  const characters = [
    ...
    { id: 'kangaroo', name: 'Kangaroo', selected: true },
      ...
      <div className="w-[390px] h-[844px] rounded-[28px] shadow-2xl overflow-hidden relative">
          ...
          <div className="flex-1 flex flex-col items-center">
            ...
            <div className="flex-1 flex flex-col items-center justify-center mb-8">
              ...
              <div className="relative mb-6">
                <img 
                  src="/partners/characters/PARTNER_-_KANGAROO.png"
                  alt="Kangaroo Partner"
              ...
              <div className="text-center">
                <img 
                  src="/partners/titles/Kangaroo Jumper.png"
                  alt="Jumper"
        ...
        {debug && (
          <div className="absolute top-4 right-4 bg-black bg-opacity-75 text-white p-2 rounded text-xs">
            Debug Mode: Kangaroo Jumper Character Selected
          </div>
        )}
