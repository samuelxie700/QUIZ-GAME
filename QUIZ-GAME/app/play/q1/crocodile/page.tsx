...
export default function CrocodileCharacterPage() {
  ...
  const onConfirm = () => {
    const url = `/play?avatar=${encodeURIComponent(avatar)}&partner=crocodile`;
    router.push(url);
  };
  ...
  const characters = [
    { id: 'crocodile', name: 'Crocodile', selected: true },
    { id: 'kangaroo', name: 'Kangaroo', selected: false },
    { id: 'wombat', name: 'Wombat', selected: false },
      ...
      <div className="w-[390px] h-[844px] rounded-[28px] shadow-2xl overflow-hidden relative">
          ...
          {characters.map((character) => (
            ...
            <div className="flex-1 flex flex-col items-center justify-center mb-8">
              ...
              <div className="relative mb-6">
                <img 
                  src="/partners/characters/PARTNER_-_CROCODILE.png"
                  alt="Crocodile Partner"
              ...
              <div className="text-center">
                <img 
                  src="/partners/titles/Crocodile Survivor.png"
                  alt="Survivor"
        ...
        {debug && (
          <div className="absolute top-4 right-4 bg-black bg-opacity-75 text-white p-2 rounded text-xs">
            Debug Mode: Crocodile Survivor Character Selected
          </div>
        )}
