...
export default function ChoosePage() {
  ...
  const onConfirm = () => {
    ...
    console.log('chosen:', CARDS[selected]);
    // router.push(`/next?cat=${encodeURIComponent(CARDS[selected].label)}`)
  };
        ...
        <div className="relative px-3">
          <div
            ...
            className="
              ...
              scroll-px-6
              flex gap-5 px-5 pt-[120px] pb-[140px]  /* 底部多留空间，避免被按钮挡住 */
              touch-pan-x
              no-scrollbar
            "
          >
