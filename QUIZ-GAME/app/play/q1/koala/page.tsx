...
export default function KoalaCharacterPage() {
  ...
  const onConfirm = () => {
    const url = `/play?avatar=${encodeURIComponent(avatar)}&partner=koala`;
    router.push(url);
  };
  ...
  const characters = [
    ...
    { id: 'koala', name: 'Koala', selected: true }
  ];
      ...
      <div className="w-[390px] h-[844px] rounded-[28px] shadow-2xl overflow-hidden relative">
          ...
          {characters.map((character) => (
            ...
            <div className="flex-1 flex flex-col items-center justify-center mb-8">
              ...
              <div className="relative mb-6">
                <img 
                  src="/partners/characters/PARTNER_-_KOALA.png"
                  alt="Koala Partner"
              ...
              <div className="text-center">
                <img 
                  src="/partners/titles/Koala Chill.png"
                  alt="Chill"
        ...
        {debug && (
          <div className="absolute top-4 right-4 bg-black bg-opacity-75 text-white p-2 rounded text-xs">
            Debug Mode: Koala Chill Character Selected
          </div>
        )}
